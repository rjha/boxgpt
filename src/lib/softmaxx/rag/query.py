...
def process_user_query(raw_query: str, query_config:dict[str, any]) -> list[float]:
    """Encodes user query into vector space without modifying query text."""
    model_path = query_config["model_path"]
...
def format_llm_prompt(raw_query: str, selected_chunks: List[Dict[str, Any]]) -> str:
    ...
    system_instruction = (
        "आप एक कुशल कृषि वैज्ञानिक हैं। केवल नीचे दिए गए संदर्भ (Context) के आधार पर उत्तर दें।\n"
